                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i>
                                            <span class="caption-subject bold uppercase">Job Details</span> </div>
                                    </div>
                                    ...
                                    <div class="col-md-8 text-right">
                                        ...
                                        @if ($job->status == 'request_to_delete')
                                            <a class="btn btn-danger" href="javascript:void(0);"
                                                onClick="deleteJob({{ $job->id }})" data-job="{{ $job->title }}"
                                                id="job-{{ $job->id }}"><i class="fa fa-square-o"
                                                    aria-hidden="true"></i> Delete</a>
                                        @endif

                                        <a class="btn btn-primary" href="{{ route('edit.job', ['id' => $job->id]) }}"><i
                                                class="fa fa-edit" aria-hidden="true"></i> Edit Job</a>
                        ...
                        <div class="col-lg-7">
                            <div class="job-header">
                                <div class="jobinfo">
                                    ...
                                    <h2>{{ $job->title }}</h2>
                                    <div class="ptext">{{ __('Date Posted') }}: {{ $job->created_at->format('M d, Y') }}
                                    </div>
                                ...
                                <div class="jobmainreq">
                                    <div class="jobdetail">
                                        <h3><i class="fa fa-align-left" aria-hidden="true"></i> {{ __('Job Details') }}
                                        </h3>
                                        ...
                                        <ul class="jbdetail">
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col-md-8 col-xs-7">
                                                    <span>{{ isset($company) ? $company->name : null }}</span></div>
                                            </li>
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col-md-8 col-xs-7"><span>{{ $job->num_of_positions }}</span>
                                                </div>
                                            </li>
                                            ...
                                            <li class="row">
                                                ...
                                                <div class="col-md-8 col-xs-7"><span>{{ $job->getGender('gender') }}</span>
                                                </div>
                                            </li>
                            ...
                            <div class="job-header">
                                <div class="contentbox">
                                    <h3><i class="fa fa-file-text-o" aria-hidden="true"></i> {{ __('Job Description') }}
                                    </h3>
                                    <p>{!! $job->description !!}</p>
                                </div>
                            </div>
                            ...
                            <div class="job-header">
                                <div class="contentbox">
                                    <h3><i class="fa fa-puzzle-piece" aria-hidden="true"></i> {{ __('Skills Required') }}
                                    </h3>
                                    <ul class="skillslist">

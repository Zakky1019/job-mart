...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'title') !!}">
        ...
        {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Job title']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div">
        ...
        <span id="default_state_dd">
            {!! Form::select('state_id', ['' => 'Select State'], null, ['class' => 'form-control', 'id' => 'state_id']) !!}
        </span>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div">
        ...
        <span id="default_city_dd">
            {!! Form::select('city_id', ['' => 'Select City'], null, ['class' => 'form-control', 'id' => 'city_id']) !!}
        </span>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_from') !!}" id="salary_from_div">
        ...
        {!! Form::number('salary_from', null, ['class' => 'form-control', 'id' => 'salary_from']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
        ...
        {!! Form::number('salary_to', null, ['class' => 'form-control', 'id' => 'salary_to']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
        ...
        {!! Form::select('salary_currency', ['' => 'Select Salary Currency'] + $currencies, null, [
            'class' => 'form-control',
            'id' => 'salary_currency',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div">
        ...
        {!! Form::select('job_type_id', ['' => 'Select Job Type'] + $jobTypes, null, [
            'class' => 'form-control',
            'id' => 'job_type_id',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div">
        ...
        {!! Form::select('job_shift_id', ['' => 'Select Job Shift'] + $jobShifts, null, [
            'class' => 'form-control',
            'id' => 'job_shift_id',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
        ...
        {!! Form::select('num_of_positions', ['' => 'Select Positions#'] + MiscHelper::getNumPositions(), null, [
            'class' => 'form-control',
            'id' => 'num_of_positions',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div">
        ...
        {!! Form::select('gender_id', ['' => __('No preference')] + $genders, null, [
            'class' => 'form-control',
            'id' => 'gender_id',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        ...
        {!! Form::select('degree_level_id', ['' => 'Select Required Degree Level'] + $degreeLevels, null, [
            'class' => 'form-control',
            'id' => 'degree_level_id',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
        ...
        {!! Form::select('job_experience_id', ['' => 'Select Required job experience'] + $jobExperiences, null, [
            'class' => 'form-control',

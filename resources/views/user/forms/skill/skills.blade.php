<div class="resumebuildwrap">
    ...
    <a href="javascript:;" class="prolinkadd" data-bs-toggle="modal" data-bs-target="#add_skill_modal"
        onclick="showProfileSkillModal();"> {{ __('Add Skill') }} </a>
</div>
<div class="modal fade" id="add_skill_modal" tabindex="-1" aria-labelledby="addskilModalLabel" aria-hidden="true"
    role="dialog"></div>
@push('scripts')

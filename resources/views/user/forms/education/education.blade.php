<div class="resumebuildwrap">
    ...
    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#add_education_modal" class="prolinkadd"
        onclick="showProfileEducationModal();"> {{ __('Add Education') }} </a>

</div>

<div class="modal fade" id="add_education_modal" tabindex="-1" aria-labelledby="addexpModalLabel" aria-hidden="true"
    role="dialog"></div>

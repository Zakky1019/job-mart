<div class="resumebuildwrap">
    ...
    <a href="javascript:;" class="prolinkadd" data-bs-toggle="modal" data-bs-target="#add_experience_modal"
        onclick="showProfileExperienceModal();"> {{ __('Add Experience') }} </a>
</div>

<div class="modal fade" id="add_experience_modal" tabindex="-1" aria-labelledby="addexpModalLabel" aria-hidden="true"
    role="dialog"></div>
@push('styles')
    <style type="text/css">
        .datepicker>div {

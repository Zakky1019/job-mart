                        ...
                        <ul class="searchList">
                                    ...
                                    <li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9 col-sm-9">
                                                ...
                                                <div class="jobinfo">
                                                    <h3><a
                                                            href="{{ route('user.profile', $user->id) }}">{{ $user->getName() }}</a>
                                                    </h3>
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                <div class="listbtn"><a
                                                        href="{{ route('user.profile', $user->id) }}">{{ __('View Profile') }}</a>
                                                </div>
                            ...
                            @else
                                <div class="nodatabox">
                                    ...
                                    <div class="viewallbtn mt-2"><a
                                            href="{{ url('/job-seekers') }}">{{ __('Search Candidates') }}</a></div>
                                </div>
                            @endif
